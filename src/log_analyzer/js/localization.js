var localization = {
    ...
    locale_dicts: {
        "ru": {
            ...
            "TableScreen.HeaderDescription": "Для известных версий CMS автоматически применяется вайтлист, чтобы отфильтровать файлы из стандартной комплектации. С помощью кнопки “Фильтр” можно загрузить дополнительный вайтлист.<p>Чтобы взять файл на анализ, нажмите на кнопку “Карантин”. Чтобы удалить файл, нажмите на кнопку “Удалить”. Скрипт для выполнения этих действий будет сформирован в поле “Предписание” в нижней части страницы. Скопируйте его в буфер обмена и выполните через вкладку “Лечение” в сканере Manul.",
        ...
        "en": {
            ...
            "TableScreen.HeaderDescription": "Whitelists are downloaded automatically for popular CMS versions to filter out the standard package files. Additional whitelists can be downloaded manually using the Filter button.<p>Click on the Quarantine button to put a file into the quarantine archive. To delete a file, click on Delete. A script containing these actions will be formed in the Prescription field in the lower part of the page. Copy it to the clipboard and execute it via the Treatment tab in the Manul scanner.",
        ...
        "ua": {
            ...
            "TableScreen.HeaderDescription": "Для відомих версій CMS автоматично застосовується вайтлист, щоб відфільтрувати файли зі стандартної комплектації. За допомогою кнопки «Фільтр/Порівняння» можна завантажити додатковий вайтлист або попередній лог перевірки, щоб порівняти його з поточним. <p>Щоб взяти файл на аналіз, натисніть кнопку «Карантин». Щоб видалити файл, натисніть кнопку «Видалити». Скрипт буде сформовано в полі «Припис» у нижній частині сторінки. Скопіюйте його в буфер обміну і виконайте через вкладку «Лікування» у сканері.",
