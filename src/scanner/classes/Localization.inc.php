...
define('PS_FURTHER_INSTRUCTIONS_1', 'Нажмите на кнопку, чтобы сохранить отчёт о проверке на жёсткий диск. Отчёт можно просмотреть самостоятельно в "Анализаторе" или отправить вирусному аналитику.');
...
define('PS_FURTHER_INSTRUCTIONS_1', 'Press the button below to download the scan report. You can view the report in the Analyzer or send it to a malware analyst you trust.');
