...
define('PS_BODYTEXT', 'Нажмите на кнопку “Сканировать”, чтобы начать проверку сайта.');
...
define('PS_BODYTEXT', 'Press Scan to check your website.');
...
define('PS_BODYTEXT', 'Site kontrolü işlemini başlatmak için "Taramayı başlat” butonuna tıklayın.');
...
define('PS_BODYTEXT', 'Натисніть кнопку «Сканувати», щоб почати перевірку сайту.');
