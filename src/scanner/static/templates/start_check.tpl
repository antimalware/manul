      ...
      <div class="body__content">
        ...
        <div>
            <table cellspacing=0 cellpadding=5 border=0>
               ...
               <tr align=left><td>{PS_CHECKER_PERM}</td><td><span class="{PS_CHECKER_PERM_STYLE}">{PS_CHECKER_PERM_STATUS}</span></td><td><div style="display: {PS_CHECKER_PERM_FIX}"><a href="#" target=_blank class="fix_link">{PS_CHECKER_FIX}</a></div></td></tr>
            </table>
